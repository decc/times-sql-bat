...
echo when process in ('ALUFOR01') then 'affor'   >> AgBatchUpload.sql
...
echo when process in ('ALU00','ALU01','MINBSLURRY1','AGSOI01','AGSOI02','AGSOI03','AGSOI04') then 'lulucf'  >> AgBatchUpload.sql
...
echo sum(case when period='2060' then pv else 0 end)::numeric "2060" >> AgBatchUpload.sql
echo from vedastore >> AgBatchUpload.sql
echo where attribute='VAR_FOut' and commodity='ALAND' and process='ALUFOR01'  >> AgBatchUpload.sql
